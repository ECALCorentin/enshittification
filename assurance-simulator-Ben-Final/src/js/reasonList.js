...
function validation(choix) {
  scrollList.classList.remove("fake-options-list-open"); // On ferme la liste
  arrow.classList.remove("arrowUp"); // Remet la flèche vers le bas

  choice.innerHTML = choix; // Affiche le choix sélectionné
